          ...
          <div className=" relative w-full md:w-1/2 P-5">
            <div className="bg-gradient-to-r from-[#37C1F1] to-[#37BDB0] p-10 w-full text-left rounded-lg mb-3 shadow-lg">
             <div className="flex justify-between items-center">
                <div className="flex gap-3 items-center"><RiDashboardFill  className="text-white text-2xl md:text-5xl font-bold bg-white/30 p-1 rounded-lg" />
            ...
            <div className="bg-white shadow-lg p-10 w-full text-left rounded-lg mb-3">
             <div className="flex justify-between items-center">
             <div className="flex gap-3 items-center"><PiVideoFill  className="text-[#115991] text-2xl md:text-5xl font-bold bg-white/30 p-1 rounded-lg" />
                <h3 className="text-[#115991] text-xl md:text-2xl font-bold">Demo</h3>  
                </div>
                <div>
            ...
            <div className="bg-white shadow-lg p-10 w-full text-left rounded-lg mb-3">
             <div className="flex justify-between items-center">
             <div className="flex gap-3 items-center"><MdHub  className="text-[#115991] text-2xl md:text-5xl font-bold bg-white/30 p-1 rounded-lg" />
                <h3 className="text-[#115991] text-xl md:text-2xl font-bold">Resource Hub</h3>  
                </div>
                <div>
                <MdKeyboardArrowRight className="text-[#115991] text-3xl"/>

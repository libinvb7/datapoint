...
export function BackgroundBoxesDemo() {
  return (
    <div className="container h-[400px] relative w-full overflow-hidden custom-solutions-mask  flex flex-col items-center justify-center rounded-lg boxes-custom-background">
      ...
      Streamline your Shop Floor with <span className="bg-gradient-to-r from-[#1873ac]  to-[#2ca9e0] bg-clip-text text-transparent"><br></br>
      SQCDP Board Visual Management Software
              </span>
            </h2>
            <p className="text-center  text-sm lg:text-xl my-7 max-w-[650px] relative z-20">Maximise productivity and optimise shop floor operations with a digital SQCDP board designed for real-time performance tracking.</p>
